<template>
  <a-form-model ref="emailLoginForm" :model="params" :rules="rules" @submit="handleSubmit" @submit.native.prevent>
    <a-form-model-item prop="identity">
      <a-input v-model.trim="params.identity" :placeholder="$t('AUTH.EMAIL')" size="large">
...
@Component
export default class LoginByEmail extends Vue {
  ...
  public handleSubmit(): void {
    const loginForm: any = this.$refs.emailLoginForm;
